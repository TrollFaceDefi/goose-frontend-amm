...
export const TROLL = new Token(ChainId.MAINNET, '0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3', 18, 'TROLL', 'TrollFace Defi')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [USDT, ...WETH_ONLY[ChainId.MAINNET], USDC, DAI, BUSD, USDT, EOS, DOT, BTCB, ETH, TROLL]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], DAI, USDC, BUSD, USDT, EOS, DOT, BTCB, ETH, TROLL]
}

// used to construct the list of all pairs we consider by default in the frontend
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [USDC, ...WETH_ONLY[ChainId.MAINNET], DAI, BUSD, USDT, EOS, DOT, BTCB, ETH, TROLL]
}
...
export const ALLOWED_PRICE_IMPACT_LOW: Percent = new Percent(JSBI.BigInt(500), BIPS_BASE) // 1%
export const ALLOWED_PRICE_IMPACT_MEDIUM: Percent = new Percent(JSBI.BigInt(1000), BIPS_BASE) // 3%
export const ALLOWED_PRICE_IMPACT_HIGH: Percent = new Percent(JSBI.BigInt(2500), BIPS_BASE) // 5%
